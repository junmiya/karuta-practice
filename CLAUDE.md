...
## Recent Changes
- 101-karuta-app-spec: Added TypeScript 5.x (Frontend: Vite + React 18, Backend: Node.js 18+ for Cloud Functions) + React 18, react-router-dom 6, Firebase Web SDK 10, Tailwind CSS 3, Firebase Admin SDK (Functions)
- 004-stage0-12card-practice: Added TypeScript 5.x（Frontend: Vite + React 18、Backend: Node.js 18+ for Cloud Functions） + React 18, React Router 6, Firebase SDK 10, Tailwind CSS 3
- 003-official-banzuke: Added TypeScript 5.x (frontend), Node.js 18+ (Cloud Functions)
